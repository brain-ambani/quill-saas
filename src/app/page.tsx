...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper
        className="mb-12 mt-28 sm:mt-40 flex
    flex-col items-center justify-center text-center"
      ...
      {/* value proposistion sections */}
      <div>
        <div className="relative isolate">
          <div
            aria-hidden="true"
            className="pointer-event-none absolute insert-x-0 -top-40 -z-10
          ...
          >
            ...
            rotate-[30deg] bg-gradient-to-tr from-[#ff60b5] to-[#9089fc]
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div
                  className="-m-2 rounded-xl bg-gray-9--/5
                ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4"
                >
                  <Image
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-large text-gray-600">
              Chatting to your PDF files has been easier than with Scriptify.
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div
              className="flex flex-col spae-2 border-l-4 border-zinc-300
          ...
          <li className="md:flex-1">
            ...
            >
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Try out Scriptify today - it really takes
                less than a minute.
              </span>
            </div>
          </li>
